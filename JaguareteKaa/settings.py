...
SECRET_KEY = 'w0)e(-eb@5m$0ktmb$2f(1x-#p0v9e54i7qqj4x5kkkkk&#bn@'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'ecommerce.context_processors.get_ecommerce',
            ],
        },
    },
]
...
DATABASES = {
    'default': {
        ...
        # 'NAME': BASE_DIR / 'db.sqlite3', # Comenzó a dar alertas en consola al iniciar la app
